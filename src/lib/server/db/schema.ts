...
export const workspace = pgTable(
	'workspace',
	{
		...
		zohoPresenterUserId: text('meeting_host_user_id'),
		zohoXZsource: text('zoho_x_zsource'),
		zohoDefaultMeetingTopic: text('meeting_default_topic'),
		zohoDefaultAgenda: text('meeting_default_agenda'),
		zohoAddAttendeeEmails: boolean('meeting_add_attendee_emails').notNull().default(true),
		zohoAutoCreateMeetings: boolean('meeting_auto_create').notNull().default(true),
...
export const booking = pgTable(
	'booking',
	{
		...
		zohoMeetingKey: text('meeting_external_id'),
		zohoJoinLink: text('meeting_join_link'),
		zohoStartLink: text('meeting_start_link'),
		zohoMeetingPayload: text('meeting_payload'),
